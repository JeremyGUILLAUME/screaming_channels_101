...
KeyRanks = []
KeyRanks.append( np.load(data_directory+"KRs/KeyRanks_%s_%d_%dattacks.npy"%(dataset_name,target_freqs[0],nb_attacks))   )
KeyRanks.append( np.load(data_directory+"KRs/KeyRanks_%s_%d_%dattacks.npy"%(dataset_name,target_freqs[1],nb_attacks))   )
KeyRanks.append( np.load(data_directory+"KRs/KeyRanks_Combined_%s_%dattacks.npy"%(dataset_name,nb_attacks))   )
...
plt.plot([0] + range_nbTraces, np.average( KeyRanks[0], axis=0), 'red', label=str(target_freqs[0])+" Hz")
plt.plot([0] + range_nbTraces, np.average( KeyRanks[1], axis=0), 'orange', label=str(target_freqs[1])+" Hz")
plt.plot([0] + range_nbTraces, np.average( KeyRanks[2], axis=0), 'seagreen', label="Combination")
